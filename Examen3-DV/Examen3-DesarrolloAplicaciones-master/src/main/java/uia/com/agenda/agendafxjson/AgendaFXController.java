...
public class AgendaFXController implements Initializable {
    ...
    @FXML
    private Label nameLabelEventoCol;
    @FXML
    ...
    private EventoDTO eventoActualDTO=null;
    ...
    public void handleNewEvento(ActionEvent actionEvent) throws IOException {
        ...
        if (okClicked) {
            this.contactoActualDTO.getItemsEventoDTO().add(this.controllerEvento.getEventoActualDTO());
            this.miAgenda.agregaEvento(this.contactoActualDTO.getName(), this.controllerEvento.getEventoActualDTO());
            this.serializa();
